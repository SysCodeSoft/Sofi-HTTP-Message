...
use Sofi\HTTP\interfaces\HeadersInterface;
/**
 * Response
 *
 ...
 */
class Response extends \Sofi\HTTP\message\Message implements ResponseInterface
{
    /**
     * Status code
     *
    ...
    public function __construct($status = 200, HeadersInterface $headers = null, StreamInterface $body = null)
    {
        ...
        $this->headers = $headers ? $headers : new \Sofi\HTTP\Headers();
        $this->body = $body ? $body : new \Sofi\HTTP\Body(fopen('php://temp', 'r+'));
    }
    /**
